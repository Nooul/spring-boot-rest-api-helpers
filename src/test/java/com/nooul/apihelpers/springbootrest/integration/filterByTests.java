...
public class filterByTests {
    ...
    @Test
    void reference_test_conjunctive_equality_in_list__fetch_actors_that_have_played_in_all_movies_of_query() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void reference_match__fetch_movie_by_actor_id() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void disjunctive_reference_match__fetch_movie_by_multiple_actor_ids() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void fetch_by_multiple_ids__fetch_movies_by_ids() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void fetch_by_multiple_ids__fetch_movies_by_not_including_ids() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void fetch_by_id__fetch_movie_by_id() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void fetch_by_id__fetch_movie_by_id_and_name_with_or_on_first_level() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void fetch_by_id__fetch_movie_by_not_id() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void exact_match_of_primitive__fetch_movie_by_name() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void  exact_match_of_primitive_in_primitive_collection__fetch_movie_by_age_rating() {
    ...
    @Test
    void two_level_many_to_many_fetch_movies_with_actor_id() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void two_level_many_to_many_fetch_movies_with_actor_first_name() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void two_level_many_to_many_fetch_movies_with_actor_first_name_and_id_overrides() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void two_level_many_to_many_fetch_movies_with_actor_first_name_like() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void two_level_many_to_one_fetch_movies_with_director_first_name_exact() {
    ...
    @Test
    void three_level_fetch_actors_of_movies_with_director_first_name_exact() {
    ...
    @Test
    void three_level_fetch_actors_of_movies_with_director_first_name_like() {
    ...
    @Test
    void two_level_many_to_many_fetch_movies_with_actor_having_firstName_and_last_name_in_three_equivalent_ways() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
...
//    @Test
//    void two_level_many_to_many_fetch_actors_with_movies_starting_with_matr_or_const() {
//        Movie matrix = new Movie();
//        matrix.setName("The Matrix");
//        movieRepository.save(matrix);
//
...
//    }
    ...
    @Test
    void two_level_exact_match_of_primitive__fetch_movie_by_director_name() {
    ...
    @Test
    void  two_level_full_text_search__fetch_movie_like_director_name() {
    ...
    @Test
    void two_level__fetch_movie_like_director_name() {
    ...
    @Test
    void  two_level__fetch_movie_with_director_id() {
    ...
    @Test
    void search_text_on_primitive__fetch_movie_by_name_prefix() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void search_text_on_primitive__fetch_movie_by_name_postfix() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void search_text_on_primitive__fetch_movie_by_name_infix() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void search_text_on_primitive__fetch_movie_by_not_containing_name_prefix() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void filter_by_primary_key_that_is_native_uuid() {
    ...
    @Test
    void filter_by_foreign_key_that_is_native_uuid() {
        UUIDEntity entity1 = new UUIDEntity();
        uuidEntityRepository.save(entity1);
    ...
    @Test
    void search_text_on_primitive__fetch_movie_by_not_containing_name_postfix() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void exact_match_of_primitive__fetch_movie_by_not_name() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void disjunctive_exact_match_of_primitives__fetch_movie_by_list_of_names() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
    ...
    @Test
    void full_text_search_in_all_fields() {
        Movie matrix = new Movie();
        matrix.setName("The Matrix");
        movieRepository.save(matrix);
