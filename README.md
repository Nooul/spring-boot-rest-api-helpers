...
* Special case to check if an entity is associated with another entity or is null - below is the only syntax that will work (note {id: null} won't work). The following will bring movies with no director or director with id = 1 or id = 2
```
